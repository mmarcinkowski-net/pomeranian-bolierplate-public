  ...
  return (
    <div>
      ...
      <div className="mydiv-3">
        Jestem bardzo unikalnym elementem 3<span>abcd 3.1</span>
        <p>
          <span>abcd 3.2</span>
          <span>abcd 3.3</span>
        </p>
      ...
      <div className="sib">Jestem bardzo unikalnym elementem 8</div>
      <p className="sib">Jestem paragrafem</p>
      <div>Jestem bardzo unikalnym elementem 9</div>
      <div>Jestem bardzo unikalnym elementem 10</div>
    </div>
  );
}
